...
public class ChatbotService{
    ...
    public Chat saveUserMessageToRedis(Long carOwnerId, ChatbotRequest request) {
    ...
    public Chat saveBotMessageToRedis(Long carOwnerId, String content) {
    ...
    public Long getCarIdByOwnerId(Long carOwnerId) {
        CarOwner carOwner = carOwnerRepository.findById(carOwnerId)
                .orElseThrow(() -> new RuntimeException("Car owner not found with id: " + carOwnerId));
        return carOwner.getCar().getId();
    }
